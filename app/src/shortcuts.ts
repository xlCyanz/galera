...
export const SHORTCUTS = [
  ...
  { id: "underline", label: "Subrayado", group: "Edición", keys: { key: "u", mod: true } },
  {
    id: "nudgeLeft",
  ...
  { id: "toolTable", label: "Tabla", group: "Herramientas", keys: { key: "b" } },
  { id: "toolFlow", label: "Zona de texto", group: "Herramientas", keys: { key: "f" } },
